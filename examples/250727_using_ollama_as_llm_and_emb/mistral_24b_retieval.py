...
def main():
    ...
    os.environ["OLLAMA_HOST"] = os.getenv("OLLAMA_HOST", "http://127.0.0.1:11435")
    # Assumed llm model settings
    Cheap_model = "mistral:7b"
    ...
    WORKING_DIR = "./250801_mistral_24b"
    ...
    with io.open (f"/data/hallucination/250726_muyu/250727_nano_graphrag/nano-graphrag/examples/250727_using_ollama_as_llm_and_emb/mistral_24b.json", "w") as f:
